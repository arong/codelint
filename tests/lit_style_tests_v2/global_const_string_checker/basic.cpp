...
// CHECK-MESSAGES: :[[@LINE-1]]:19: warning: global const std::string initialized with string
// literal should be 'constexpr const char*'  [codelint-global-const-string]
...
// CHECK-MESSAGES: :[[@LINE-1]]:12: warning: global const std::string initialized with string
// literal should be 'constexpr const char*'  [codelint-global-const-string]
