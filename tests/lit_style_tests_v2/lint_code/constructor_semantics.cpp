...
void test_safe_to_convert() {
  ...
  // CHECK-MESSAGES: :42:15: warning: variable should use '{}' syntax for initialization
  // [codelint-lint-code]
  std::string str2("world");
  // CHECK-MESSAGES: :44:15: warning: variable should use '{}' syntax for initialization
  // [codelint-lint-code]

  std::vector<int> vec1 = {1, 2, 3};
  // CHECK-MESSAGES: :47:20: warning: initializer should use '{}' syntax instead of '= {}'
  // [codelint-lint-code]
}
...
void test_mixed_types() {
  ...
  // CHECK-MESSAGES: :61:15: warning: variable should use '{}' syntax for initialization
  // [codelint-lint-code]
}
