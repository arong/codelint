...
// CHECK-MESSAGES: :[@LINE]:7: warning: condition must be bool type, but got 'const char *'  [codelint-strict-bool-condition]
  ...
  if (nullptr) {
// CHECK-MESSAGES: :[@LINE]:7: warning: condition must be bool type, but got 'nullptr_t'  [codelint-strict-bool-condition]
  }
  if (1) {
// CHECK-MESSAGES: :[@LINE]:7: warning: condition must be bool type, but got 'int'  [codelint-strict-bool-condition]
  }
...
// CHECK-MESSAGES: :[@LINE]:7: warning: condition must be bool type, but got 'int'  [codelint-strict-bool-condition]
  ...
  if (3.14) {
// CHECK-MESSAGES: :[@LINE]:7: warning: condition must be bool type, but got 'double'  [codelint-strict-bool-condition]
  }
