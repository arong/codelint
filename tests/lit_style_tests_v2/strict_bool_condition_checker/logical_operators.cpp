...
void test_logical_operators() {
  ...
  if (!x) {
    // CHECK-MESSAGES: [[@LINE-1]]:8: warning: condition must be bool type, but got 'int'
  ...
  if (!d) {
    // CHECK-MESSAGES: [[@LINE-1]]:8: warning: condition must be bool type, but got 'double'
    // [codelint-strict-bool-condition]
  }
  ...
  if (b && s) {
    // CHECK-MESSAGES: [[@LINE-1]]:12: warning: condition must be bool type, but got 'const char *'
    // [codelint-strict-bool-condition]
  }
  if (x && s) {
    // CHECK-MESSAGES: [[@LINE-1]]:7: warning: condition must be bool type, but got 'int'
