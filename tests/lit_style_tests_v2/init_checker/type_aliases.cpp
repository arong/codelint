...
IntAlias alias1;
// CHECK-MESSAGES: :8:10: error: variable is not initialized  [codelint-init]
DoubleAlias alias2;
...
using IntAlias2 = int;
IntAlias2 alias3;
// CHECK-MESSAGES: :15:11: error: variable is not initialized  [codelint-init]
...
// CHECK-MESSAGES: :22:12: error: variable is not initialized  [codelint-init]
  LocalDouble local_alias2;
// CHECK-MESSAGES: :24:15: error: variable is not initialized  [codelint-init]
}
