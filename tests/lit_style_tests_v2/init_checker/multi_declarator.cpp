...
// CHECK-FIXES:   int initialized{10}, uninitialized{}, also_initialized{20}; // Only uninitialized should warn
// CHECK-FIXES:   unsigned u1{1U}, u2{}, u3{3U}; // u2 should warn, and suggest U suffix
// CHECK-FIXES: }
