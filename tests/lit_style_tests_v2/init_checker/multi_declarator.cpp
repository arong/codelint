...
void test_multiple_declarators() {
  int a, b,
      c; // All three should trigger warnings
         // CHECK-MESSAGES: :6:7: warning: variable is not initialized  [codelint-init]
         // CHECK-MESSAGES: :6:10: warning: variable is not initialized  [codelint-init]
         // CHECK-MESSAGES: :7:7: warning: variable is not initialized  [codelint-init]
  double x = 1.0, y, z = 3.0; // Only y should trigger warning
  // CHECK-MESSAGES: :[[@LINE-1]]:19: warning: variable is not initialized  [codelint-init]
  char *p1, *p2, *p3; // All three should trigger warnings
  // CHECK-MESSAGES: :[[@LINE-1]]:9: warning: variable is not initialized  [codelint-init]
  // CHECK-MESSAGES: :[[@LINE-2]]:14: warning: variable is not initialized  [codelint-init]
  // CHECK-MESSAGES: :[[@LINE-3]]:19: warning: variable is not initialized  [codelint-init]
  ...
  // CHECK-MESSAGES: :[[@LINE-2]]:16: warning: C-style array is not initialized  [codelint-init]
...
void test_mixed_initialization() {
  ...
  // CHECK-MESSAGES: :[[@LINE-1]]:25: warning: variable is not initialized  [codelint-init]
  unsigned u1 = 1U, u2, u3 = 3U; // u2 should warn, and suggest U suffix
  // CHECK-MESSAGES: :[[@LINE-1]]:21: warning: variable is not initialized  [codelint-init]
}

void test_single_declarators() {
  int single;        // Should trigger warning
                     // CHECK-MESSAGES: :[[@LINE-1]]:7: warning: variable is not initialized
                     // [codelint-init]
...
public:
  void method() {
    ...
    // CHECK-MESSAGES: :[[@LINE-1]]:9: warning: variable is not initialized  [codelint-init]
    // CHECK-MESSAGES: :[[@LINE-2]]:13: warning: variable is not initialized  [codelint-init]
    // CHECK-MESSAGES: :[[@LINE-3]]:17: warning: variable is not initialized  [codelint-init]
...
// CHECK-MESSAGES: :[[@LINE-2]]:14: warning: variable is not initialized  [codelint-init]
// CHECK-MESSAGES: :[[@LINE-3]]:23: warning: variable is not initialized  [codelint-init]
