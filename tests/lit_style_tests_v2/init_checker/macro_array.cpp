...
// CHECK-FIXES: int initialized_array[5]{};           // This SHOULD trigger a warning (suggest brace init)
// CHECK-FIXES: int brace_initialized[5]{};           // This should NOT trigger a warning
// CHECK-FIXES: int assigned_array[5]{1, 2, 3, 4, 5}; // This SHOULD trigger a warning (suggest brace init)
// CHECK-FIXES: float float_array[10]{};              // This SHOULD trigger a C-style array warning
// CHECK-FIXES: void function_test() {
