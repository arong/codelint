...
// CHECK-MESSAGES: :[@LINE]:18: error: variable is not initialized  [codelint-init]
...
TestClass tc1;
// CHECK-MESSAGES: :[@LINE]:11: warning: variable is not explicitly initialized  [codelint-init]
...
// CHECK-MESSAGES: :[@LINE]:5: error: field is not initialized  [codelint-init]
  int outer_val;
// CHECK-MESSAGES: :[@LINE]:7: error: field is not initialized  [codelint-init]
} outer1;
// CHECK-MESSAGES: :[@LINE]:3: error: variable is not initialized  [codelint-init]
...
DerivedClass dc1;
// CHECK-MESSAGES: :[@LINE]:14: warning: variable is not explicitly initialized  [codelint-init]
