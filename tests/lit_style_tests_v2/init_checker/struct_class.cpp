...
// CHECK-MESSAGES: :[[@LINE-1]]:18: warning: variable is not initialized  [codelint-init]
...
struct Outer {
  ...
  // CHECK-MESSAGES: :[[@LINE-1]]:5: warning: field is not initialized  [codelint-init]
  int outer_val;
  // CHECK-MESSAGES: :[[@LINE-1]]:7: warning: field is not initialized  [codelint-init]
} outer1;
// CHECK-MESSAGES: :[[@LINE-1]]:3: warning: variable is not initialized  [codelint-init]
