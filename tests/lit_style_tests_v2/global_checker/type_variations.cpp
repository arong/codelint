...
// Test file: type_variations.cpp
// Scenario: All types of global variables - merged from multiple files
// Expected: 19 global variables detected (sum of all merged files)

#include <string>
#include <vector>

// ============================================================================
// MERGED FROM: basic_globals.cpp
// ============================================================================
// Basic int types
int global_int = 42;
...
// ============================================================================
// MERGED FROM: static_globals.cpp
// ============================================================================
