...
void count_severities(const std::vector<codelint::lint::LintIssue>& issues,
...
std::vector<codelint::lint::LintIssue> collect_issues(
...
std::map<std::string, std::vector<codelint::lint::LintIssue>> group_issues_by_file(
    const std::vector<codelint::lint::LintIssue>& issues) {
