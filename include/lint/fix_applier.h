...
public:
     ...
     */
    bool applyFixes(const std::vector<LintIssue>& issues,
     ...
     */
    int getAppliedFixCount() const { return applied_fix_count_; }
...
private:
     ...
     */
    bool applyUninitializedFix(const LintIssue& issue,
     ...
     */
    bool applyEqualsSyntaxFix(const LintIssue& issue,
                              const std::vector<std::string>& lines,
                              std::string& replacement_text,
                              size_t& offset,
                              size_t& length);
     ...
     */
    size_t findInsertionPoint(const std::string& line,
