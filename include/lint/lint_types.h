...
inline std::string check_type_to_string(CheckType type) {
  switch (type) {
  case CheckType::INIT_UNINITIALIZED:
    return "init_uninitialized";
  case CheckType::INIT_EQUALS_SYNTAX:
    return "init_equals_syntax";
  case CheckType::INIT_UNSIGNED_SUFFIX:
    return "init_unsigned_suffix";
  case CheckType::GLOBAL_VARIABLE:
    return "global_variable";
  case CheckType::SINGLETON_PATTERN:
    return "singleton_pattern";
  case CheckType::CONST_SUGGESTION:
    return "const_suggestion";
  case CheckType::CAN_BE_CONST:
    return "can_be_const";
  case CheckType::CAN_BE_CONSTEXPR:
...
inline CheckType string_to_check_type(const std::string& str) {
  if (str == "init_uninitialized")
    return CheckType::INIT_UNINITIALIZED;
  if (str == "init_equals_syntax")
    return CheckType::INIT_EQUALS_SYNTAX;
  if (str == "init_unsigned_suffix")
    return CheckType::INIT_UNSIGNED_SUFFIX;
  if (str == "global_variable")
    return CheckType::GLOBAL_VARIABLE;
  if (str == "singleton_pattern")
    return CheckType::SINGLETON_PATTERN;
  if (str == "const_suggestion")
    return CheckType::CONST_SUGGESTION;
  if (str == "can_be_const")
    return CheckType::CAN_BE_CONST;
  if (str == "can_be_constexpr")
    return CheckType::CAN_BE_CONSTEXPR;
